...
public class BakedPlayerCurrency_Final implements IBakedModel {
    private final IBakedModel model;
    private final IBakedModel shapeModel[];
    private final IBakedModel primeModel[];
    private ItemStack itemStack;

    public BakedPlayerCurrency_Final(IBakedModel model, IBakedModel[] shapeModel, IBakedModel[] primeModel){
        this.model = model;
    ...
    public BakedPlayerCurrency_Final setCurrentItemStack(ItemStack itemStack) {
