    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        switch (page) {
            ...
            case "wallet1":
                ...
                this.itemRender.renderItemIntoGUI(ItemStack.EMPTY, guiLeft + 65, guiTop + 86);
                ...
                this.itemRender.renderItemIntoGUI(ItemStack.EMPTY, guiLeft + 46, guiTop + 124);
                this.itemRender.renderItemIntoGUI(new ItemStack(Items.LEATHER), guiLeft + 65, guiTop + 124);
                this.itemRender.renderItemIntoGUI(ItemStack.EMPTY, guiLeft + 84, guiTop + 124);
            ...
            case "vending6":
                ...
                this.itemRender.renderItemIntoGUI(new ItemStack(Items.IRON_INGOT), guiLeft + 46, guiTop + 86);
                this.itemRender.renderItemIntoGUI(new ItemStack(Items.COMPARATOR), guiLeft + 65, guiTop + 86);
                this.itemRender.renderItemIntoGUI(new ItemStack(Items.IRON_INGOT), guiLeft + 84, guiTop + 86);

                this.itemRender.renderItemIntoGUI(new ItemStack(Items.IRON_INGOT), guiLeft + 46, guiTop + 105);
                this.itemRender.renderItemIntoGUI(new ItemStack(Blocks.CHEST), guiLeft + 65, guiTop + 105);
                this.itemRender.renderItemIntoGUI(new ItemStack(Items.IRON_INGOT), guiLeft + 84, guiTop + 105);

                this.itemRender.renderItemIntoGUI(new ItemStack(Items.IRON_INGOT), guiLeft + 46, guiTop + 124);
                this.itemRender.renderItemIntoGUI(new ItemStack(Items.IRON_DOOR), guiLeft + 65, guiTop + 124);
                this.itemRender.renderItemIntoGUI(new ItemStack(Items.IRON_INGOT), guiLeft + 84, guiTop + 124);
            ...
            case "exchange5":
                ...
                this.itemRender.renderItemIntoGUI(new ItemStack(Items.IRON_INGOT), guiLeft + 46, guiTop + 96);
                this.itemRender.renderItemIntoGUI(new ItemStack(Items.REPEATER), guiLeft + 65, guiTop + 96);
                this.itemRender.renderItemIntoGUI(new ItemStack(Items.IRON_INGOT), guiLeft + 84, guiTop + 96);

                this.itemRender.renderItemIntoGUI(new ItemStack(Items.IRON_INGOT), guiLeft + 46, guiTop + 115);
                this.itemRender.renderItemIntoGUI(new ItemStack(Blocks.CHEST), guiLeft + 65, guiTop + 115);
                this.itemRender.renderItemIntoGUI(new ItemStack(Items.IRON_INGOT), guiLeft + 84, guiTop + 115);

                this.itemRender.renderItemIntoGUI(new ItemStack(Items.IRON_INGOT), guiLeft + 46, guiTop + 134);
                this.itemRender.renderItemIntoGUI(new ItemStack(Items.IRON_DOOR), guiLeft + 65, guiTop + 134);
                this.itemRender.renderItemIntoGUI(new ItemStack(Items.IRON_INGOT), guiLeft + 84, guiTop + 134);
